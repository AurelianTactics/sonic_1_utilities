...
class PrioritizedReplayBuffer(ReplayBuffer):
    ...
    def save_samples(self):
        #pickle.dump(self.transitions,open('transitions.p',wb))
        with open('transitions.p','wb') as handle:
    ...
    def load_samples(self):
        #self.transitions = pickle.load(open("transitions.p","rb"))
        temp_trans = pickle.load(open("human_transitions.p","rb"))
        for i in temp_trans:
            self.add_sample(i)
